...
public class SkwyvernsDAO {
	...
	public boolean insertDB(SkwyvernsDTO skwyvernsDTO) {
		...
		String sql ="insert into qa(title,name, memo) values(?,?,?)";
	...
	public ArrayList<SkwyvernsDTO> getDBList() {
		...
		String sql = "select id, title, name, memo from qa";
	...
	public boolean updateDB(int id, SkwyvernsDTO skwyvernsDTO) {
		...
		String sql ="update qa set title=? ,name=? ,memo=? where id=?";
		try {
	...
	public boolean deleteDB(int id) {
		...
		// id로 매칭하여 delete				
		String sql ="delete from qa where id=?";
