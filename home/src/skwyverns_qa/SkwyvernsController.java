...
//어너테이션 서블릿과 URL 정의
@WebServlet(description = "skwyverns Controller 서블릿", urlPatterns = { "/skwyverns_qa/SkwyvernsController" })
		...
		try {
		   ...
		   // pageContext 참조변수 객체 생성
			...
			if(action.equals("add")) {
				...
				pageContext.forward("skwyverns_Q&A_view.jsp");
				...
				if(skwyvernsDAO.insertDB(skwyvernsDTO)) {
					...
					// 결과 조회를 위하여 조회화면 호출
					pageContext.forward("skwyverns_Q&A_list.jsp");
