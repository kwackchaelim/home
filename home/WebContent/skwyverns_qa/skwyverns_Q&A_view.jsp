...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="../skwyverns/skwyverns_list.css">
<script type="text/javascript" src="../skwyverns/skwyverns_view.js"></script>
<title>Q&A</title>
</head>
<body>
...
<div id="main_lnb">
	...
	<li class = "menu">
        ...
        <div class="article">
          <a href="../skwyverns/skwyverns_list.jsp">자유게시판</a>
          <a href="#">To.SKwyverns</a>
          <a href="#">From.SKwyverns</a>
          <a href="skwyverns_Q&A_list.jsp">Q & A</a>
          </div>
        </li>
        <li class = "menu">
		...
		<div class="bottom_button">
			...
			<input type="button" class="button" id="back" value="돌아가기" onClick="backcheck()">
         	...
         	<aside id="main_aside">
            <h3>팬</h3><hr><br>
				<small><a href="../skwyverns/skwyverns_list.jsp">자유게시판</a></small><br><hr><br>
				<small><a href="#">To.SKwyverns</a></small><br><hr><br>
				<small><a href="#">From.SKwyverns</a></small><br><hr><br>
				<small><a href="skwyverns_Q&A_list.jsp">Q & A</a></small><br><hr><br>
            </aside>
    </div>
